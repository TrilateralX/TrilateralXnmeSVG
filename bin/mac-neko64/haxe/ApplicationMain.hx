...
class ApplicationMain
{
   ...
   public static var winWidth:Float = 1000;
   public static var winHeight:Float = 1000;
   ...
   public static function main()
   {
      ...
      if (closePreloader!=null)
         ...
         nme.app.Application.setPackage("Nanjizal", "Application", "net.trilateralX.TrilateralXnmeSVG", "0.0.1");
         #if HXCPP_TELEMETRY
         ...
         else
         {
            wx.App.boot(function()
            {
               var size = { width: 1000, height: 1000 };
                  ...
                  frame = wx.Frame.create(null, null, "TrilateralXnmeSVG", null, size);
               
               nme.Lib.title = "TrilateralXnmeSVG";
